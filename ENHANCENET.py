        ...
        if not len(model_list) == 0:
            ...
            for i in range(-1, 0, 1):
                ...
                self.gt_list = [
                    ...
                    for f in os.listdir(os.path.join(self.datasetpath))
                ...
                for n, img_name in enumerate(self.gt_list):
                    ...
                    img = Image.open(
                        os.path.join(self.datasetpath, img_name + self.im_suf_A)
                    ).convert("RGB")
                    ...
                    cv2.imwrite(
                        os.path.join(path_fakeB, "%s.png" % img_name), B_fake * 255.0
                    )
